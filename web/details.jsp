      ...
      <div class="modal-body">
        <form action="/details" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="recipient-name" name="task_name" value="<%=task.getName()%>">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="task_date" name="task_date" value="<%=task.getDate()%>">
          </div>
          <div class="mb-3">
